...
CREATE TABLE ROADMAPS (
    ...
    CONSTRAINT PUBLISHER_FK FOREIGN KEY (PUBLISHER) REFERENCES USERS(USERNAME)
);
...
CREATE TABLE ROADMAP_AREAS (
    ...
    CONSTRAINT PARENT_ID_FK FOREIGN KEY (PARENT_ID) REFERENCES ROADMAP_AREAS(ID)
);
...
CREATE TABLE USER_ROADMAPS (
    ...
    CONSTRAINT ROADMAP_ID_FK FOREIGN KEY (ROADMAP_ID) REFERENCES ROADMAPS(ID)
);
